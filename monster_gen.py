...
def gen_aquatic_piranha(level, coords):
    ...
    creature_com = Creature(creature_name, hp=max_health, base_atk=attack,
                            base_def=defence,
                            base_hit_chance=hit_chance, base_evasion=doge_value, xp_gained=xp_granted,
                            dead_animation_key="S_FLESH_FISH")
    ai_com = ai.AiChase()

    fish = Actor(x, y, "Fish", animation_key="A_AQUATIC_PIRANHA", depth=constants.DEPTH_CREATURE,
                      creature=creature_com,
                      ai=ai_com)
...
def gen_aquatic_jellyfish(level, coords):
    ...
    fish = Actor(x, y, "Fish", animation_key="A_AQUATIC_JELLYFISH", depth=constants.DEPTH_CREATURE,
                      creature=creature_com,
                      ai=ai_com)
...
def gen_aquatic_jellyofwar(level, coords):
    x, y = coords
    ...
    fish = Actor(x, y, "Fish", animation_key="A_AQUATIC_JELLYOWAR", depth=constants.DEPTH_CREATURE,
                      creature=creature_com,
                      ai=ai_com)
...
def gen_aquatic_shark(level, coords):
    ...
    fish = Actor(x, y, "Shark", animation_key="A_AQUATIC_SHARK", depth=constants.DEPTH_CREATURE,
                      creature=creature_com,
                      ai=ai_com)
...
def gen_aquatic_shark_white(level, coords):
    ...
    fish = Actor(x, y, "White Shark", animation_key="A_AQUATIC_SHARK_WHITE", depth=constants.DEPTH_CREATURE,
                      creature=creature_com,
                      ai=ai_com)
...
def gen_aquatic_shark_gold(level, coords):
    ...
    fish = Actor(x, y, "Fish", animation_key="A_AQUATIC_SHARK_GOLD", depth=constants.DEPTH_CREATURE,
                      creature=creature_com,
                      ai=ai_com)
...
def gen_aquatic_whale(level, coords):
    ...
    fish = Actor(x, y, "Whale", animation_key="A_AQUATIC_WHALE", depth=constants.DEPTH_CREATURE,
                      creature=creature_com,
                      ai=ai_com)
